...
export const DateFilterMethod = {
  ...
  'next-3-days': 'com.affine.filter.next 3 days',
  'next-7-days': 'com.affine.filter.next 7 days',
  'next-15-days': 'com.affine.filter.next 15 days',
  'next-30-days': 'com.affine.filter.next 30 days',
